...
${xpath_bouton_login}           xpath=//button[contains(text(),'${texte_bouton_connexion}')]
${xpath_bouton_deconnexion}     xpath=//a[contains(text(),'${texte_bouton_deconnexion}')]
${xpath_bouton_creer_compte}    xpath=//button[contains(text(),'${texte_bouton_creer_compte}')]
